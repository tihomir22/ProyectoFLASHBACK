		...
		<video autoplay muted loop id="videoBG">
			...
			<div class="row" id="forja">		
				...
				<div id="conteForja" class="row" style="display:none;color:white;width: 100%;">
						...
						<div class="card-body" id="logros_zone">	
							...
							<p class="card-text" >
								...
								for ($i=0; $i <$longitud ; $i++) { 
									...
									echo '
									<div class="objects" id="object'.$logro_encontrado['idlogros'].'" draggable="true" ondragstart="drag_start(event)" ondragend="drag_end(event)">'.$logro_encontrado['exp_logro'].'<img src="'.$imagen.'" style="width:50px;height:50px;z-index:-1;"></div>
									';
								}
								?>	
							</p>
					...
					<br>
					<button name="boton" onclick="readDropZone()">Get Object Data</button>
					<button id="forjarBtn" class="btn btn-outline-danger btn-large" style="display:none;">FORJAR</button>
